                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="cedula" type="text" class="form-control @error('cedula') is-invalid @enderror" name="cedula" required autocomplete="cedula">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button id="registrar" type="submit" class="btn btn-primary bg-green-500 text-white border-green-500 hover:bg-orange-600 hover:border-orange-600 hover:text-black">
                                    {{ __('Register') }}
                                </button>
                            </div>
                        </div>
